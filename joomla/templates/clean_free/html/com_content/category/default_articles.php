...
<form action="<?php echo htmlspecialchars(Uri::getInstance()->toString() ?? ""); ?>" method="post" name="adminForm" id="form-inline">
			...
			<td headers="categorylist_header_title" class="list-title">
				<?php if (in_array($article->access, $this->user->getAuthorisedViewLevels())) : ?>
					...
					<?php if (Associations::isEnabled() && $this->params->get('show_associations')) : ?>
						...
						<?php else: ?>
							<?php $associations = Joomla\Component\Content\Site\Helper\AssociationHelper::displayAssociations($article->id); ?>
						<?php endif; ?>
