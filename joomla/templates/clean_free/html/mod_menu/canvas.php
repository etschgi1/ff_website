...
?>
<ul class="menu uk-nav <?php echo $class_sfx; ?>"<?php echo $id; ?>>
...

{
	...
	switch ($item->type) :
		...
		case 'url':
			...
			break;
		case 'separator':
			require ModuleHelper::getLayoutPath('mod_menu', 'default_canvas_' . $item->type);
			break;
		default:
	...
	if ($item->deeper)
	{
		echo '<ul class="uk-nav-sub menu-child">';
	}
