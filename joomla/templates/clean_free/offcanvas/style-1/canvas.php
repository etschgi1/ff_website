...
<div id="tm-dialog" class="uk-offcanvas" uk-offcanvas="mode:<?php echo $dialog_offcanvas_mode; ?>;<?php echo $dialog_offcanvas_overlay; echo $dialog_offcanvas_flip; ?>">

<div class="uk-offcanvas-bar uk-flex uk-flex-column<?php echo $dialog_menu_horizontally; ?>">
